...
let IPH = function () {
  ...
  function IPH(username, password) {
    _classCallCheck(this, IPH);
  ...
  /**
   * Get IP address History Threat Intelligence
   * @param {string} ipAddress - IPv4/IPv6 Address to get history threat intelligence for
   * @returns {Promise<T>}
   */
